...
class TestGeorssKml < Test::Unit::TestCase
  ...
  def test_geometry_creation
    ...
    assert_equal("<geo:lat>4</geo:lat><geo:lon>3</geo:lon>",point.as_georss(:dialect => :w3cgeo).gsub("\n",""))
  ...
  def test_line_string
    ...
    assert_equal("<geo:lat>-45.3</geo:lat><geo:lon>12.4</geo:lon>",ls.as_georss(:dialect => :w3cgeo).gsub("\n",""))
  ...
  def test_polygon
    ...
    assert_equal("<bouyoul:lat>-45.3</bouyoul:lat><bouyoul:lon>12.4</bouyoul:lon>",polygon.as_georss(:dialect => :w3cgeo, :w3cgeo_ns => "bouyoul").gsub("\n",""))
  ...
  def test_geometry_collection
    ...
    assert_equal("<geo:lat>45.4</geo:lat><geo:lon>4.67</geo:lon>",gc.as_georss(:dialect => :w3cgeo).gsub("\n",""))
  ...
  def test_envelope
    ...
    #center
    assert_equal("<geo:lat>-1.85</geo:lat><geo:lon>24.928</geo:lon>",e.as_georss(:dialect => :w3cgeo).gsub("\n",""))
